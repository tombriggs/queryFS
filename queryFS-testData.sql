...
INSERT INTO queryFS_query(queryName, queryText) VALUES('queryFS_schemas', 'SELECT * FROM INFORMATION_SCHEMA.SCHEMATA');
INSERT INTO queryFS_queryDirectoryMap(queryId, directoryId) VALUES(LAST_INSERT_ID(), 5);
